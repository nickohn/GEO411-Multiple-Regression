...
- There is no such thing as a perfect model, so do not agonize over it. If you do that, the fatigue and frustration can lower your ability to properly interpret results.
